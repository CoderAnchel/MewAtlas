    ...
    <>
      ...
      {Window && (
        <div className="Window">
          <span className="closer" onClick={() => setWindow(!Window)}>
            ❌
          </span>
          <div className="windowWrapper">
            ...
            <button
              className="sender"
              onClick={() => putData(email, user, password)}
            >
              CREATE
            </button>
          </div>
      ...
      {Window2 && (
        <div className="Window">
          <span className="closer" onClick={() => setWindow2(!Window2)}>
            ❌
          </span>
          <div className="windowWrapper">
            ...
            <button className="sender" onClick={() => getUser(user, password)}>
              ENTER
            </button>
          </div>
        </div>
